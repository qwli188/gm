...
const RARITY_MULT := {"common": 1.0, "rare": 1.4, "epic": 1.9, "legendary": 2.6, "mythic": 3.5}

# 稀有度中文名（UI 统一来源）
const RARITY_DISPLAY := {
	"common": "普通", "rare": "稀有", "epic": "史诗", "legendary": "传奇", "mythic": "神话"
}
...
const CLASS_SHORT := {
	...
	"class_frost_witch": "frost_witch",
	"class_shadow_archer": "shadow_archer"
}

# ============ 6 套装 ============
const SET_IDS := [
	"set_bone", "set_plague", "set_ember", "set_frost", "set_void", "set_eternal_warrior"
]
